...
PREresult = pd.DataFrame(oof_predictions)
PREresult = PREresult.iloc[:, 1]
result1 = pd.concat([df, PREresult], axis=1)
result1.rename(columns={1: "颅内感染风险"}, inplace=True)
